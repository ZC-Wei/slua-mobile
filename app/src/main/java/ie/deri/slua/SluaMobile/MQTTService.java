...
public class MQTTService extends Service
{
    ...
    private static final String		MQTT_HOST = "slua.deri.ie";
    private static int				MQTT_BROKER_PORT_NUM      = 8009;
    private static MqttPersistence	MQTT_PERSISTENCE          = null;
    private static int[]			MQTT_QUALITIES_OF_SERVICE = { 0 } ;
    public static String			MQTT_CLIENT_ID = "crowd";
    ...
    public static String            NOTIFICATION_TITLE = "SLUA Mobile";
    private static final int        NOTIFICATION_CONNECTED = 0;
    ...
    private void showNotification(String text) {
        ...
        PendingIntent pi = PendingIntent.getActivity(this, 0,
                new Intent(this, Login.class), PendingIntent.FLAG_CANCEL_CURRENT);

        // Change the name of the notification here
        n.setLatestEventInfo(this, NOTIFICATION_TITLE, text, pi);

        mNotificationManager.notify(NOTIFICATION_CONNECTED, n);
    }
